...
const SideBar = ({ pathname }) => {
  ...
  return (
    <>
      <div className="bg-blue text-white min-h-svh  sticky top-0">
        <div className="flex flex-row gap-2 justify-center items-center py-4  px-3 border-b-2 border-b-gray-200">
          <svg
        ...
        <div className="p-4">
          <ul className="flex flex-col gap-4">
            ...
            <li
              className={`flex flex-col gap-2 text-lg font-medium    cursor-pointer ${"text-base-300"} `}
            >
