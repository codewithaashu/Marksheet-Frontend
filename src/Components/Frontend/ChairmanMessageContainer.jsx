...
const ChairmanMessageContainer = () => {
  return (
    <>
      <div className="flex flex-col gap-5 w-[694px] px-2">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-[15px] font-medium">
            ...
            had to be a well-planned and organized extended learning endeavor
            which allowed students to pursue other activities without affecting
            ...
            right away. The instructional resources made available to the
            students are without the bottleneck of language. They have the
            option to choose the language of their study material. The results
            ...
            the world. You can choose subjects from the scheme of studies given
            in table. However, you will be required to successfully complete a
...
export default ChairmanMessageContainer;
